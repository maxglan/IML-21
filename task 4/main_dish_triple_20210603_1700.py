...
leaky_relu01 = layers.LeakyReLU(alpha=0.1)
leaky_relu03 = layers.LeakyReLU(alpha=0.3)


def model_creator(dim_red_nodes: int=100, 
                  dim_red_act=leaky_relu01, 
                  dense1_nodes: int=30, 
                  dense1_act=leaky_relu01, 
                  dense2_nodes: int=12, 
                  dense2_act=leaky_relu01): 
    ...
    dim_red = layers.Dense(dim_red_nodes, activation=dim_red_act, input_shape=(len(feature_list),))
    ...
    dense1 = layers.Dense(dense1_nodes, activation=dense1_act)(flatten)
    dense1 = layers.BatchNormalization()(dense1)
    dense2 = layers.Dense(dense2_nodes, activation=dense2_act)(dense1)
...
model = model_creator(dim_red_nodes=100, 
                      dense1_nodes=25, 
                      dense1_act=leaky_relu01,
                      dense2_nodes=7,
                      dense2_act=leaky_relu03)
...
# dimred 100, dense1 30, dense2, 12 all reaky_relu, classifier 1 sigmoid
